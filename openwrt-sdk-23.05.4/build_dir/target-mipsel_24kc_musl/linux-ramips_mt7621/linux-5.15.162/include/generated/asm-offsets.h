...
#define TASK_MM 604 /* offsetof(struct task_struct, mm) */
#define TASK_PID 736 /* offsetof(struct task_struct, pid) */
#define TASK_STACK_CANARY 744 /* offsetof(struct task_struct, stack_canary) */
#define TASK_STRUCT_SIZE 1568 /* sizeof(struct task_struct) */
...
#define THREAD_REG16 1420 /* offsetof(struct task_struct, thread.reg16) */
#define THREAD_REG17 1424 /* offsetof(struct task_struct, thread.reg17) */
#define THREAD_REG18 1428 /* offsetof(struct task_struct, thread.reg18) */
#define THREAD_REG19 1432 /* offsetof(struct task_struct, thread.reg19) */
#define THREAD_REG20 1436 /* offsetof(struct task_struct, thread.reg20) */
#define THREAD_REG21 1440 /* offsetof(struct task_struct, thread.reg21) */
#define THREAD_REG22 1444 /* offsetof(struct task_struct, thread.reg22) */
#define THREAD_REG23 1448 /* offsetof(struct task_struct, thread.reg23) */
#define THREAD_REG29 1452 /* offsetof(struct task_struct, thread.reg29) */
#define THREAD_REG30 1456 /* offsetof(struct task_struct, thread.reg30) */
#define THREAD_REG31 1460 /* offsetof(struct task_struct, thread.reg31) */
#define THREAD_STATUS 1464 /* offsetof(struct task_struct, thread.cp0_status) */
#define THREAD_BVADDR 1528 /* offsetof(struct task_struct, thread.cp0_badvaddr) */
#define THREAD_BUADDR 1532 /* offsetof(struct task_struct, thread.cp0_baduaddr) */
#define THREAD_ECODE 1536 /* offsetof(struct task_struct, thread.error_code) */
#define THREAD_TRAPNO 1540 /* offsetof(struct task_struct, thread.trap_nr) */
...
#define MM_CONTEXT 384 /* offsetof(struct mm_struct, context) */
