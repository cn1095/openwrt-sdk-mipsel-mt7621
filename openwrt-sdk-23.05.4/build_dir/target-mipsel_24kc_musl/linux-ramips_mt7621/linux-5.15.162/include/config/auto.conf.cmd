...
ifneq "$(KERNELVERSION)" "5.15.162"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "mipsel-openwrt-linux-musl-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "mipsel-openwrt-linux-musl-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "mipsel-openwrt-linux-musl-gcc (OpenWrt GCC 12.3.0 r24012-d8dd03c46f) 12.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "mipsel-openwrt-linux-musl-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "mipsel-openwrt-linux-musl-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "mipsel-openwrt-linux-musl-ar"
include/config/auto.conf: FORCE
endif
